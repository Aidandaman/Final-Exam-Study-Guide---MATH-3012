...
\label{Module 4}
    ...
    \begin{itemize}
        ...
        \item Consistently use correct vocabulary and notation, with sufficient work, to discuss and work with generating functions, found at \textcolor{navy}{\autoref{Module 4.7}}.
        \item Define and give examples of integer partitions, found at \textcolor{navy}{\autoref{Module 4.8}}.
        \item Use generating functions to model the number of integer partitions satisfying a given set of conditions, found at \textcolor{navy}{\autoref{Module 4.9}}.
...
\subsubsection{\textcolor{lime}{\textbf{POTENTIAL BONUS}}: Partial Fraction Decomposition.}
    \begin{itemize}
